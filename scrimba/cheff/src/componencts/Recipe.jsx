    ...
    return (
        <section>
            ...
            <article className="space-y-6" aria-live="polite">
                <p className="text-gray-600">Based on the ingredients you have available, I would recommend making a simple a delicious <strong>Beef Bolognese Pasta</strong>. Here is the recipe:</p>
                ...
                <ol className="list-decimal ms-6 space-y-5 text-lg text-gray-600">
