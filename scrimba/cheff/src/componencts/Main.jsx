...
export function Main() {
    ...
    return (
        <main className="max-w-xl m-auto mt-16 space-y-10">
            <form method="post" onSubmit={hendleSubmit} className="flex items-center justify-center gap-4">
                <input type="text" name="ingredient" className="w-full border border-gray-300 shadow-inner rounded-md py-1.5 px-2" placeholder="e.g. oreagano" />
