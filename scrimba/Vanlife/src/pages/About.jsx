        ...
        <>
            ...
            <div className='px-4 space-y-14'>
                ...
                <div className="p-8 rounded-lg bg-[#FFCC8D] text-[#161616] mb-10 space-y-6">
                    ...
                    <Link type="button" className="w-full focus:outline-none text-white bg-[#161616] font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 transition delay-100 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 ">Explore our vans</Link>
                </div>
            </div>
        </>
