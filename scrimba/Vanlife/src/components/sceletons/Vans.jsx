...
export const Vans = () => {
    const vans = Array.from({ length: 8 }, (_, i) => i + 1);
    ...
    return (
        <>
            ...
            <div className="grid gap-8 grid-cols-2 md:grid-cols-3 xl:grid-cols-4 space-y-8">
                {vans.map((van) => (
                    <div key={van} role="status" className="max-w-sm animate-pulse">
                        <div className="flex items-center justify-center h-56 w-full  mb-4 bg-gray-300 rounded-lg">
