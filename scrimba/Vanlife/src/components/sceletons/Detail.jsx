        ...
        <>
            <section className="py-8 antialiased md:py-12">
                <div className="mx-auto max-w-screen-lg px-4 2xl:px-0 space-y-6">
                    <div role="status" class="animate-pulse md:p-6">
                        <div class="flex items-center justify-center h-98 mb-4 bg-gray-300 rounded-sm">
                        ...
                        <div class="h-3 bg-gray-200 rounded-full w-48 mb-6"></div>
                        <div class="h-3 bg-gray-200 rounded-full w-20 mb-6"></div>
